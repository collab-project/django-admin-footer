...
class VersionTestCase(TestCase):
    """
    Tests for :py:mod:`~admin_footer` versioning information.
    """
    def test_regularVersion(self):
        """
        :py:func:`~admin_footer.get_version` returns a string version without
        any beta tags, e.g. ``1.0.1``.
        """
        version = (1, 0, 1)
    ...
    def test_betaVersion(self):
        """
        :py:func:`~admin_footer.get_version` returns a string version with
